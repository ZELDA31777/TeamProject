        ...
        <!-- 네비 목록 시작 -->
            <div class="collapse navbar-collapse justify-content-end mynavbar" id="navbarsExample04">
               <ul class="navbar-nav mb-2 mb-md-0">
                  ...
                  <!-- 현재 주소 정보 가져오기 -->
                  <c:set var="nowUri" value="${requestScope['javax.servlet.forward.request_uri']}" />
                  ...
                  <sec:authorize access="hasAnyRole('ADMIN' , 'SUPER_ADMIN')">
                     <li class="nav-item"><a class="nav-link ${(fn:contains(nowUri, 'tip_list.do'))?'active':'' }" href="/tip/tip_list.do">가이드 & Tip</a></li>
                     <li class="nav-item"><a class="nav-link ${(fn:contains(nowUri, 'notice_list.do'))?'active':'' }" href="/notice/notice_list.do">공지사항</a></li>
                     <li class="nav-item"><a class="nav-link ${(fn:contains(nowUri, 'admin_cor_list.do'))?'active':'' }" href="/admin/manage/admin_cor_list.do">중개사 회원관리</a></li>
                     <li class="nav-item"><a class="nav-link ${(fn:contains(nowUri, 'admin_user_list.do'))?'active':'' }" href="/admin/manage/admin_user_list.do">일반 회원관리</a></li>
                  </sec:authorize>
                  ...
                  <sec:authorize access="hasRole('MEMBER')">
                       <li class="nav-item"><a class="nav-link ${(fn:contains(nowUri, 'map_view.do'))?'active':'' }" href="/map/map_view.do">지도</a></li>
                     <li class="nav-item"><a class="nav-link ${(fn:contains(nowUri, 'cor_view.do'))?'active':'' }" href="/coroperation/cor_view.do?username=${username }">내 매물관리</a></li>
                     <li class="nav-item"><a class="nav-link ${(fn:contains(nowUri, 'alert_list.do'))?'active':'' }" href="/alert/alert_list.do?username=${username }">알림</a></li>
                  </sec:authorize>
                  
                  <sec:authorize access="isAnonymous()">
                     <li class="nav-item"><a class="nav-link ${(fn:contains(nowUri, 'map_view.do'))?'active':'' }" href="/map/map_view.do">지도</a></li>
                     <li class="nav-item"><a class="nav-link ${(fn:contains(nowUri, 'looked_room_non.do'))?'active':'' }" href="/favorite/looked_room_non.do">관심목록</a></li>
                     <li class="nav-item"><a class="nav-link ${(fn:contains(nowUri, 'alert_list.do'))?'active':'' }" href="/alert/alert_list.do">알림</a></li>
