...
<div class="container-fluid subcontent">
	<div class="container" style="width: 50%">
		<form id="userForm" class="needs-validation" method="post" action="/user/user_modify_cor_pro.do" enctype="multipart/form-data" novalidate>
	        ...
	        <input type="hidden" name="nickname" value="${uvo.nickname }">
	        <input type="hidden" name="tel" id="tel" value="${cvo.tel }">
			...
			<div class="styled__Box-sc-1etb7tu-1 cubPeM">
				...
				<div class="input-with-label__InputWrap-sc-1p3gkts-0 eVAGdp">
					<label class="bDaqny">
						...
						class="form-control kHDHPO" id="username" value="${uvo.username }"
						placeholder="이메일 주소 입력"
						pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" readonly required>
					</label>
				</div>
				<div class="input-with-label__InputWrap-sc-1p3gkts-0 eVAGdp">
					<label class="bDaqny">
				...
				<div class="input-with-unit__InputWrap-sc-1e4qgti-0 eVAGdp">
					<label class="bDaqny">
						...
						id="name" placeholder="대표자명 입력" value="${cvo.name }"
				...
				<div class="input-with-unit__InputWrap-sc-1e4qgti-0 eVAGdp">
					<label class="bDaqny">
						...
						id="corname" placeholder="중개사무소명 입력" value=${cvo.corname }
						class="form-control kHDHPO" maxlength="10" required>
						<div class="valid-feedback">확인되었습니다</div>
				...
				<div class="input-with-unit__InputWrap-sc-1e4qgti-0 eVAGdp">
					<label class="bDaqny">
						...
						id="cornum" placeholder="-를 포함하여 입력해주세요" value=${cvo.cornum }
				...
				<div class="eVAGdp">
					<div class="bDaqny">
						...
						<div class="row gy-3">
							...
							<div class="col-12">
								<input type="text" class="form-control kHDHPO" id="addr3" value="${cvo.addr }" required>
								<div class="valid-feedback">확인되었습니다.</div>
				...
				<input type="hidden" name="username" value="${uvo.username}">
						<button color="blue" class="button__Button-sc-153m1au-0 fiEZwu modify_button"
